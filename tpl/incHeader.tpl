...
<link rel="stylesheet" href="{$_upDir}css/sweetalert.css" TYPE="text/css">
...
<script src="{$_upDir}xml_js/sweetalert.min.js"></script>
...
<body>
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container" style="min-height:auto"> <!-- MAIN CONTAINER -->
