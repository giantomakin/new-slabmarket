...
<div class="col-md-9">
	    ...
	    <div class="col-sm-12 col-md-6">
	      <div class="panel panel-default">
	        ...
	        <div class="panel-body">
	          ...
	          <a href="{$_upDir}login"><button type="button" class="btn btn-default pull-right">Choose Your Slab Now </button></a>
	        </div>
	      </div>
	    </div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-12 well" >
		  ...
		  <a href="{$UpDir}interviews/Import-straight-from-quarry-at-low-prices" class="btn btn-info pull-right">Read More</a>
		</div>
		<br>
		<div class="col-sm-12 well" style="margin-top:10px;">
		  ...
		  <a href="{$UpDir}interviews/Attract-previously-unreachable-clients" class="btn btn-info pull-right">Read More</a>
		</div>
