		...
		<div class="panel-body" style="max-width: 500px; margin: 0 auto;">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<a href="#"><button type="button" class="btn btn-default pull-right">Read More Now</button></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="panel-body">
			<div class="btn-group btn-group-justified" role="tablist" aria-label="...">
				<div class="btn-group" role="group">
					<button type="button" class="btn btn-default" href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Building a Container</button>
				</div>
				<div class="btn-group" role="group">
					<button type="button" class="btn btn-default" href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Placing the Order</button>
				</div>
				<div class="btn-group" role="group">
					<button type="button" class="btn btn-default" href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Transfer of Legal Documents</button>
				</div>
				<div class="btn-group" role="group">
					<button type="button" class="btn btn-default" href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab">Shipping Process</button>
				</div>
			</div>
			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane active" id="tab1">
					<div class="col-sm-6 left-section">
						...
						<ul>
							...
							<li>Select the thickness and quantity</li>
							<li>Add to the container</li>
							<li>Repeat until container is full</li>
						</ul>
					</div>
					<div class="col-sm-6 right-section"><img src="{$UpDir}img/buyslabs1.jpg"></div>
				</div>
				...
				<div role="tabpanel" class="tab-pane" id="tab2">
					<div class="col-sm-6 left-section">
						...
						<ul>
							...
							<li>Agree to the total cost (now including shipping)</li>
							<li>Approve photos of slabs sent by the quarry</li>
							<li>Wire the deposit to us</li>
						</ul>
					</div>
					<div class="col-sm-6 right-section"><img src="{$UpDir}img/buyslabs2.jpg"></div>
				</div>

				<div role="tabpanel" class="tab-pane" id="tab3">
					<div class="col-sm-6 left-section"><img src="{$UpDir}img/buyslabs3.jpg"></div>
				...
				<div role="tabpanel" class="tab-pane" id="tab4">
					<div class="col-sm-6 left-section"><img src="{$UpDir}img/buyslabs4.jpg"></div>
					<div class="col-sm-6 right-section">
						<h2>Shipping Process</h2>
						<ul>
							<li>Slabs packaged into the container and shipped to the harbor</li>
							<li>You get notified of the estimated delivery date</li>
							<li>Slabs arrive at a US harbor and get customs clearance</li>
							<li>Your order arrives at the location you specified</li>
						</ul>
					</div>
				</div>
