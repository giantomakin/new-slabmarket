            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3>"Attract previously unreachable clients"- Roberto Vieira</h3>
                </div>

                <div class="panel-body">
                  <h4>Roberto Vieira is the CEO of BSE – a brazilian granite manufacturer and exporter. Below are excerpts from our interview with him.</h4><br/>
